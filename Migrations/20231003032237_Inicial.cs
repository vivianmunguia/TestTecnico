        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NombreProducto = table.Column<string>(type: "varchar(80)", nullable: false),
                    Precio = table.Column<double>(type: "decimal", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsuarioProducto", x => x.Id);
                });
        }
